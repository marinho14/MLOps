...
def run_train():
    ...
    TARGET = "specie"
    COLUMNS_RENAME_DICT = {"CulmenDepth": "culmenLen",
                        "CulmenLength": "culmenDepth",
                        "FlipperLength": "flipperLen",
                        "BodyMass": "bodyMass",
                        "Sex": "sex",
                        "Delta15N": "delta15N",
                        "Delta13C": "delta13C",
    ...
    joblib.dump(tree, '/opt/airflow/models/tree.pkl')
    joblib.dump(random_tree, '/opt/airflow/models/random_tree.pkl')

    # # # 7. Put label encoder for sex in prod
    joblib.dump(sex_label_encoder, '/opt/airflow/encoders/sex_label_encoder.pkl')
